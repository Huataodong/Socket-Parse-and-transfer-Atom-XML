...
public class ContentServer2 {
    ...
    public static void main(String args[]) throws IOException {
        ...
        ContentServer2Thread cst = new ContentServer2Thread(socket);
        cst.start();
...
//                    System.out.println(strLine);
                    ...
                    count++;
                    os.println("Lamport Clock Timestamp: CS2: ");
                    os.println(count);

                    //count Content-Length
                    BufferedReader reader = new BufferedReader(new FileReader("data2.xml"));
                    int ContentLength = 0;
                    ...
                    String message = new String(Files.readAllBytes(Paths.get("data2.xml")));
    ...
    //external thread to send heartbeat to AggregationServer
    static class ContentServer2Thread extends Thread implements Runnable {

        Socket socket;
        public ContentServer2Thread(Socket s)
        {
            socket = s;
        }
    ...
    public String read() throws IOException {
        try {
            //read file
            in = new BufferedReader(new FileReader("data2.txt"));

            //after parsing, save to an xml file
            out = new StreamResult("data2.xml");
